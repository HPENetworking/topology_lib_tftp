...
setup(
    name='topology_lib_tftp',
    version=find_version('lib/topology_lib_tftp/__init__.py'),
    package_dir={'': 'lib'},
    ...
    description=(
        'This library contains functions to configure and start a TFTP server '
    ...
    entry_points={
        'topology_library_10': [
            'tftp = topology_lib_tftp.library'
        ]
    }
)
